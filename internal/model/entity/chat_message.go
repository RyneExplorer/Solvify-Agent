...
type ChatMessage struct {
	...
	SessionID        string         `gorm:"column:session_id;type:uuid;not null;index:idx_chat_messages_session_id_created_at,priority:1"`
	...
	CreatedAt        time.Time      `gorm:"column:created_at;autoCreateTime;index:idx_chat_messages_session_id_created_at,priority:2"`
}
