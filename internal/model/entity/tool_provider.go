...
type ToolProvider struct {
	...
	AdminConfig  datatypes.JSON `gorm:"type:jsonb" json:"admin_config"` // 业务参数 {"engine":"google","num":10}
	RateLimit    datatypes.JSON `gorm:"type:jsonb" json:"rate_limit"`   // 限流 {"daily":1000}
