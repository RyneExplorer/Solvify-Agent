...
type CreateUserModelConfigRequest struct {
	...
	MaxContextLength int                    `json:"max_context_length" binding:"min=1024,max=200000"`
}
...
type UpdateUserModelConfigRequest struct {
	...
	Config           map[string]interface{} `json:"config"`
	MaxContextLength *int                   `json:"max_context_length" binding:"omitempty,min=1024,max=200000"`
}
